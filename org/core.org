...
:END:
 ...
 |---------------------+-----------------------+---------------------------|
 | NS_IMAGE_TAG        | 20.04-4.99.23         | Set NaviServer version    |
 |---------------------+-----------------------+---------------------------|
...
#+begin_src sh :shebang ""
  ...
  NS_IMAGE_TAG="${NS_IMAGE_TAG:-20.04-4.99.23}"
